...
\noindent\textbf{Code Repository:} \url{https://github.com/Haoyu-Gu/data-mining}
...
This work utilized Large Language Models (LLMs) and AI assistants for the following purposes:

\begin{itemize}
\item \textbf{Literature Review:} AI tools assisted in identifying relevant papers and summarizing recent advances in symbolic music representation learning, vector quantization, and data mining techniques.

\item \textbf{Code Development:} AI assistants provided guidance on implementing UMAP dimensionality reduction, HDBSCAN clustering, and parameter search strategies. All code has been thoroughly tested and validated by the authors.

\item \textbf{Writing Assistance:} LLMs helped with structuring sections, improving clarity, and proofreading. All technical content, experimental results, and interpretations were independently verified by the authors.

\item \textbf{Visualization:} AI tools suggested visualization approaches for clustering results and embedding space analysis.
\end{itemize}

All AI-generated content has been carefully reviewed, verified, and validated by the authors. We take full responsibility for the correctness and accuracy of all results, claims, and conclusions presented in this work. No unauthorized data or proprietary information was used, and all code and data comply with relevant licenses and ethical guidelines.
